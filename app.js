...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  var appDNA = new Types.Node({
	      ...
	      children: [ new Types.Node({
	          ...
	          children: [ new Types.Node({
	              ...
	              pathProcessor: Types.GlobalPP.value, 
	              children: [  ], 
	              dataSource: new Types.StringSource(Utils.unlines([ "This is a rich markdown editor for Github Gists, a 100% client side application written in ClojureScript to explore offline mode and multiprocessing for web applications.", "", "[C.MD](http://eugenen.github.io/C.MD)", "# ![cmd](cmd.png)", "" ]))
	          }), new Types.Node({
	              title: "pureGoL", 
	              path: "pureGoL", 
	              processor: Types.MdProcessor.value, 
	              ...
	              pathProcessor: Types.GlobalPP.value, 
	              children: [  ], 
	              dataSource: new Types.StringSource(Utils.unlines([ "This application. Experiments with better ways to build apllications.", "", "[meta.repl](https://github.com/EugeneN/meta.repl) (draft)", "# ![meta.repl](meta.repl.png)" ]))
	          }), new Types.Node({
	              title: "G4", 
	              path: "g4", 
	              processor: Types.MdProcessor.value, 
	...
	(function(exports) {
	  ...
	  var parseContent = function (_1) {
	      ...
	      throw new Error("Failed pattern match at UI.HTML.Utils line 21, column 1 - line 22, column 1: " + [ _1.constructor.name ]);
	  };
	                              ...
	                              return function (selected) {
	                                  return function (level_2) {
	                                      ...
	                                      if (_8 instanceof Data_Maybe.Just) {
	                                          ...
	                                          })()))))(Data_Foldable.for_(Text_Smolder_Markup.applicativeMarkupM)(Data_Foldable.foldableArray)(UI_HTML_Utils.getMenuItems(_8.value0))(function (_2) {
	                                              if (selected instanceof Data_Maybe.Nothing) {
	                                                  return Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.href(makeUrl(baseUrl$prime)(_2.value0)))(Text_Smolder_Markup.text(_2.value1));
	                                              };
	                                              if (selected instanceof Data_Maybe.Just) {
	                                                  var _20 = Prelude["=="](Prelude.eqString)(_2.value0)(selected.value0);
	                                                  if (_20) {
	                                                      return Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.className("current-menu-item")))(Text_Smolder_HTML_Attributes.href(makeUrl(baseUrl$prime)(_2.value0)))(Text_Smolder_Markup.text(_2.value1));
	                                                  };
	                                                  if (!_20) {
	                                                      return Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.href(makeUrl(baseUrl$prime)(_2.value0)))(Text_Smolder_Markup.text(_2.value1));
	                                                  };
	                                      ...
	                                      throw new Error("Failed pattern match: " + [ _8.constructor.name, baseUrl$prime.constructor.name, selected.constructor.name, level_2.constructor.name ]);
	                                  };
	                              };
	                          };
	                      };
	                      var _25 = Data_Array.uncons(fullPath);
	                      if (_25 instanceof Data_Maybe.Nothing) {
	                          return drawNodeMenu(new Data_Maybe.Just(_6.value0))(baseUrl)(Data_Maybe.Nothing.value)(level);
	                      };
	                      if (_25 instanceof Data_Maybe.Just && _25.value0.tail.length === 0) {
	                          return Prelude.bind(Text_Smolder_Markup.bindMarkupM)(drawNodeMenu(new Data_Maybe.Just(_6.value0))(baseUrl)(new Data_Maybe.Just(_25.value0.head))(level))(function () {
	                              return drawNodeMenu(Core.findChildNodeByPath([ _25.value0.head ])(_6.value0))(Prelude["<>"](Prelude.semigroupArray)(baseUrl)([ _25.value0.head ]))(new Data_Maybe.Just(_25.value0.head))(level + 1 | 0);
	                          });
	                      };
	                      if (_25 instanceof Data_Maybe.Just) {
	                          return Prelude.bind(Text_Smolder_Markup.bindMarkupM)(drawNodeMenu(new Data_Maybe.Just(_6.value0))(baseUrl)(new Data_Maybe.Just(_25.value0.head))(level))(function () {
	                              return renderMenu(_25.value0.tail)(Core.findChildNodeByPath([ _25.value0.head ])(_6.value0))(Prelude["<>"](Prelude.semigroupArray)(baseUrl)([ _25.value0.head ]))(level + 1 | 0);
	                          });
	                      };
	                      throw new Error("Failed pattern match: " + [ _25.constructor.name ]);
	                  };
	                  throw new Error("Failed pattern match: " + [ fullPath.constructor.name, _6.constructor.name, baseUrl.constructor.name, level.constructor.name ]);
	              };
	          };
	      };
	  };
	  ...
	  var uiLogic = function (_3) {
	      return function (_4) {
	          if (_3 instanceof Types.RenderState) {
	              ...
	              return new UIState((function () {
	                  var _40 = {};
	                  for (var _41 in _4.value0) {
	                      if (_4.value0.hasOwnProperty(_41)) {
	                          _40[_41] = _4.value0[_41];
	                      };
	                  };
	                  _40.oldVDom = _4.value0.newVDom;
	                  _40.title = Core.calcTitle(_3.value0);
	                  _40.newVDom = newVDom;
	                  return _40;
	              })());
	          };
	          ...
	          throw new Error("Failed pattern match at UI.HTML.Main line 56, column 1 - line 64, column 1: " + [ _3.constructor.name, _4.constructor.name ]);
	      };
	  };
