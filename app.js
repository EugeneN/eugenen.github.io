...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(exports) {
	  ...
	  var showPlatform = new Prelude.Show(function (_0) {
	      ...
	      throw new Error("Failed pattern match at Types line 45, column 1 - line 48, column 18: " + [ _0.constructor.name ]);
	  });
	...
	(function(exports) {
	  ...
	  var readSource = function (_2) {
	      ...
	      throw new Error("Failed pattern match at Utils line 35, column 1 - line 36, column 1: " + [ _2.constructor.name ]);
	  };
	  ...
	  var getTitle = function (_3) {
	      return _3.value0.title;
	  };
	  var getPath = function (_4) {
	...
	(function(exports) {
	          ...
	          return Prelude.bind(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.className("text mode-menu")))(Text_Smolder_HTML_Attributes.href("app.js")))(Text_Smolder_HTML_Attributes.title("To use CLI/telnet mode, please run `app.js` with Node.js and then connect to it with telnet or netcat"))(Text_Smolder_Markup.text("CLI/telnet mode")))(function () {
	              return Prelude.bind(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.h1)(Text_Smolder_HTML_Attributes.className("name"))(Text_Smolder_Markup.text(Utils.getTitle(Data.appDNA))))(function () {
	                  return Prelude.bind(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["!"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("nav"))(Data_Foldable.for_(Text_Smolder_Markup.applicativeMarkupM)(Data_Foldable.foldableArray)(UI_HTML_Utils.getMenuItems(Data.appDNA))(function (_2) {
	                      ...
	                      throw new Error("Failed pattern match at UI.HTML.Main line 96, column 1 - line 97, column 1: " + [ _12.constructor.name ]);
	                  })))(function () {
	  ...
	  var uiLogic = function (_3) {
	      return function (_4) {
	          ...
	          throw new Error("Failed pattern match at UI.HTML.Main line 53, column 1 - line 61, column 1: " + [ _3.constructor.name, _4.constructor.name ]);
	      };
	  };
	...
	(function(exports) {
	  ...
	  var showPage = function (_7) {
	      ...
	      throw new Error("Failed pattern match at UI.Telnet.Main line 108, column 1 - line 109, column 1: " + [ _7.constructor.name ]);
	  };
	  ...
	  var uiLogic = function (_5) {
	      return function (_6) {
	          ...
	          throw new Error("Failed pattern match at UI.Telnet.Main line 102, column 1 - line 104, column 1: " + [ _5.constructor.name, _6.constructor.name ]);
	      };
	  };
	          ...
	          return function (ui) {
	              return function __do() {
	                  var _0 = (function () {
	                      ...
	                      throw new Error("Failed pattern match at Main line 21, column 1 - line 29, column 1: " + [ ui.constructor.name ]);
	                  })()();
