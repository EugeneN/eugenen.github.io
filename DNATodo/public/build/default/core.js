/* Cafe 0.0.89 Thu Feb 14 2013 14:12:44 GMT+0200 (EET) */
...
(function() {
  ...
  module.exports = {
    protocols: {
      definitions: {
        INucleus: [['len', ['array']], ['add', ['vector']], ['drop', ['items_vec', 'cur_item']], ['swap', ['items_vec', 'cur_item']]]
      },
      implementations: {
        INucleus: function(node) {
          return {
            len: function(array) {
...
'index': function(exports, require, module) {(function() {
(function() {
  var DEFAULT_PROTOCOLS, Implementations, Protocols, THIS, debug, discover_impls, dispatch_impl, dump_impls, error, get_arity, get_default_protocols, get_meta, get_method, get_protocol, info, is_any, is_async, is_vararg, partial, register_protocol, register_protocol_impl, warn, _ref,
    __slice = [].slice,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  get_meta = function(ns, method_name) {
    var meta, _, _ref1;
    _ref1 = get_method(ns, method_name), _ = _ref1[0], _ = _ref1[1], meta = 3 <= _ref1.length ? __slice.call(_ref1, 2) : [];
    return meta;
  };

  is_any = function(prop, ns, method_name) {
    return __indexOf.call(get_meta(ns, method_name), prop) >= 0;
  };
  ...
  get_arity = function(ns, method_name) {
    var argums, _, _ref1;
    _ref1 = get_method(ns, method_name), _ = _ref1[0], argums = _ref1[1], _ = 3 <= _ref1.length ? __slice.call(_ref1, 2) : [];
...
'index': function(exports, require, module) {(function() {
(function() {
  var CELLS, DEBUG, DNA_DATATYPES, DNA_EXTEND, DNA_ID_PREFIX, DNA_SUBSCRIBE, HASHMAP, NAN, NULL, NUMBER, STRING, THIS, VECTOR, bool, complement, compose2, cont_m, cont_t, debug, default_handlers_cont, dispatch_handler, dispatch_handler_fn, dispatch_impl, dna_to_host_value, domonad, error, find_cell, get_arity, get_cell, get_create_cell, get_create_cell_by_id, get_default_protocols, get_method_ns, get_protocol, info, interpose_handlers_with_events, is_array, is_async, is_data, is_handler, is_null, is_object, lift, lift_async, lift_sync, logger_m, logger_t, make_extended_node, make_monadized_handler, make_subscribed_node, maybe_m, maybe_t, parse_ast_handler_node, parse_genome, partial, process_vector, register_protocol_impl, save_cell, synthesize_cell, synthesize_node, warn, _ref, _ref2, _ref3, _ref4;
  var _this = this, __hasProp = Object.prototype.hasOwnProperty, __indexOf = Array.prototype.indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (__hasProp.call(this, i) && this[i] === item) return i; } return -1; }, __slice = Array.prototype.slice;
  ...
  _ref = require('libprotein'), partial = _ref.partial, is_array = _ref.is_array, is_object = _ref.is_object, bool = _ref.bool, complement = _ref.complement, compose2 = _ref.compose2;

  parse_genome = (require('genome-parser')).parse;

  _ref2 = require('libprotocol'), register_protocol_impl = _ref2.register_protocol_impl, dispatch_impl = _ref2.dispatch_impl, get_protocol = _ref2.get_protocol, get_default_protocols = _ref2.get_default_protocols, is_async = _ref2.is_async, get_arity = _ref2.get_arity;

  _ref3 = require('libmonad'), cont_t = _ref3.cont_t, cont_m = _ref3.cont_m, maybe_t = _ref3.maybe_t, maybe_m = _ref3.maybe_m, logger_t = _ref3.logger_t, logger_m = _ref3.logger_m, domonad = _ref3.domonad, is_null = _ref3.is_null, lift_sync = _ref3.lift_sync, lift_async = _ref3.lift_async;

  _ref4 = dispatch_impl('ILogger'), info = _ref4.info, warn = _ref4.warn, error = _ref4.error, debug = _ref4.debug;
  ...
  process_vector = function(vector, cell, dom_parser, cont) {
    ...
    return vector.map(function(i, idx) {
      var h, _ref5;
      if (_ref5 = i.type, __indexOf.call(DNA_DATATYPES, _ref5) >= 0) {
        count--;
  ...
  is_data = function(method) {
    var _ref5;
    return _ref5 = method.type, __indexOf.call(DNA_DATATYPES, _ref5) >= 0;
  };
    ...
    switch (method.type) {
      ...
      case VECTOR:
        vector_handler = function(cont) {
          return process_vector(method.value, cell, dom_parser, function(res) {
            return cont(res);
          });
        };
  ...
  parse_ast_handler_node = function(handler, current_cell, dom_parser) {
    var cell, cell_id, handler_arity, handler_fn, handler_is_async, handler_ns, method, ns, real_handler, scope, _ref5;
    _ref5 = is_array(handler) ? handler[0] : handler, ns = _ref5.ns, method = _ref5.method, scope = _ref5.scope;
  ...
  interpose_handlers_with_events = function(dom_parser, cell, handlers, evs_args) {
    var args, event, ns, raw_args, scope, _ref5, _ref6;
    _ref5 = is_array(evs_args) ? evs_args : [evs_args, []], (_ref6 = _ref5[0], ns = _ref6.ns, event = _ref6.event, scope = _ref6.scope), raw_args = 2 <= _ref5.length ? __slice.call(_ref5, 1) : [];
    args = (raw_args.filter(function(a) {
      var _ref7;
      return _ref7 = a.event.type, __indexOf.call(DNA_DATATYPES, _ref7) >= 0;
    })).map(function(a) {
      return a.event.value;
    });
    return handlers.map(function(handlr) {
      var _ref7;
      return (_ref7 = dispatch_handler(ns != null ? ns.name : void 0, event.name, find_cell((scope != null ? scope.name : void 0) || THIS, cell, dom_parser))).impl.apply(_ref7, args.concat([handlr]));
    });
  };
